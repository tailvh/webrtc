...
If this is your first time using WebRTC, don't worry! We have multiple [examples](https://github.com/tailvh/webrtc/tree/master/examples) and [GoDoc](https://godoc.org/github.com/tailvh/webrtc)
